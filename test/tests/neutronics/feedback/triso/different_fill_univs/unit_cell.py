...
def unit_cell(n_ax_zones, n_inactive, n_active):
    ...
    for z_min, z_max in zip(axial_coords[0:-1], axial_coords[1:]):
        ...
        fuel_ch_cell = openmc.Cell(region=-fuel_cyl, fill=different_homogeneous_fuel_univ)
        uniform_fuel_ch_cell = openmc.Cell(region=-fuel_cyl2, fill=homogeneous_fuel_univ)
