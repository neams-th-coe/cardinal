...
spheres = openmc.model.pack_spheres(
    radius=0.25, region=overall_region, num_spheres=4, seed=1
)
...
triso_lattice = openmc.model.create_triso_lattice(
    trisos, lower_left, pitch, triso_lattice_shape, mat
)
...
model.settings.temperature = {"method": "interpolation", "range": (294.0, 3000.0)}
