...
# bottom row of cells
cell1 = openmc.Cell(
    region=+xmin & -x2 & +ymin & -ymid & +zmin & -zmax, fill=a, cell_id=1
)
cell2 = openmc.Cell(
    region=+x2 & -xmax & +ymin & -ymid & +zmin & -zmax, fill=b, cell_id=2
)
...
# top row of cells
cell3 = openmc.Cell(
    region=+xmin & -x2 & +ymid & -ymax & +zmin & -zmax, fill=c, cell_id=3
)
cell4 = openmc.Cell(
    region=+x2 & -xmax & +ymid & -ymax & +zmin & -zmax, fill=d, cell_id=4
)
