...
bundle_flat_to_flat = 0.19  # bundle flat-to-flat distance (m)
bundle_gap_width = 4e-3  # gap width between bundles (m)
height = 0.25  # height of the full core (m)
...
total_B10_wt_percent = (
    0.001  # total weight percent of B-10 in the poison material (B_nC)
)
