...
model.settings.source = openmc.IndependentSource(
    space=openmc.stats.Box(lower_left=(0, 0, 0), upper_right=(20, 5, 5))
)
...
lc = openmc.Cell(
    region=+lefts & -rights & +bot & -top & +back & -front & -middle, fill=left
)
rc = openmc.Cell(
    region=+lefts & -rights & +bot & -top & +back & -front & +middle, fill=right
)
