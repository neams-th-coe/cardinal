...
ap = ArgumentParser()
ap.add_argument(
    "-n", dest="n_axial", type=int, default=20, help="Number of axial cell divisions"
)
args = ap.parse_args()
N = args.n_axial
###############################################################
...
src_cell = openmc.Cell(
    fill=materials["void"], region=+l_plane & -x_surfaces[0] & container
)
...
source = openmc.IndependentSource(
    space=openmc.stats.Box((-1.0, 0.0, 0.0), (0.0, 2.0, 2.0)),
