...
skin a mesh according to fields such as burnup, enrichment, or any other auxiliary variable (or
indeed no variables), in addition to temperature and density.

The deprecated `temperature`, `temperature_min`, `temperature_max`, `n_temperature_bins`,
`density`, `density_min`, `density_max`, and `n_density_bins` parameters have been removed. Old
files should be modified to the new syntax.