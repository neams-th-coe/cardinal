...
- Build a flow simulation in NekRS using the [!ac](IBM)
...
to change in the future to simplify the workflow.
...
In order to use the immersed boundary method within NekRS, there is some additional software you
...
set(VTK_INCLUDE_DIR "${VTK_DIR}/include/vtk-9.3")
include_directories(${VTK_INCLUDE_DIR})
find_package(VTK 9.3 REQUIRED)

if (VTK_FOUND)
  message(STATUS "VTK FOUND: Using include path ${VTK_INCLUDE_DIR}")
  target_include_directories(UDF PRIVATE ${VTK_INCLUDE_DIR})
  target_link_libraries(UDF PRIVATE ${VTK_LIBRARIES})
...
wget "https://github.com/CGAL/cgal/releases/download/v6.2/CGAL-6.2.tar.xz"
...
This section describes how immersed boundary methods are implemented in NekRS.
