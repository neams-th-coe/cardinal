...
- Average of temperature over the volumes of the subchannels
- Average of temperature over the gaps between subchannels
- Average of the velocity normal to the gaps between subchannels

First, we will describe the averages over the volumes of the subchannels.
