...
The nondimensional parameters used in the *conj_ht* CI test are summarized in [tab:conj-ht-setup].
...
Both CI modes evaluate the volume $L_2$ error norms of the streamwise velocity and temperature fields at steady state.
...
The CI test passes when both error tolerances are satisfied,
