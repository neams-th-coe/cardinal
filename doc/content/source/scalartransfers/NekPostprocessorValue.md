...
--------------------------------------------------------------------------------------------------------
|    0 | inlet_V | bc->usrwrk[0*bc->fieldOffset+0] | platform->app->bc->o_usrwrk[0*nrs->fieldOffset+0] |
|    1 | inlet_T | bc->usrwrk[1*bc->fieldOffset+0] | platform->app->bc->o_usrwrk[1*nrs->fieldOffset+0] |
--------------------------------------------------------------------------------------------------------
```
