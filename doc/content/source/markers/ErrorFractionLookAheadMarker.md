...
element is marked for refinement.  If the spatial error from the indicator provided is within the
error fraction provided in `coarsen` or the statistical relative error is above
