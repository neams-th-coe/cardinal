...
Breeder = openmc.Material.mix_materials(
    [eurofer, beryllium, Li4SiO4, Helium], [0.1, 0.37, 0.15, 0.38], "ao", name="breeder"
)

Multiplier = openmc.Material.mix_materials(
    [beryllium, Helium], [0.65, 0.35], "ao", name="multiplier"
)
