...
flibe_cell = openmc.Cell(
    fill=flibe, region=+sphere_surface & -flibe_surface, name="Flibe"
)
repeatable_univ = openmc.Universe(cells=[sphere_cell, flibe_cell])

outer_cell = openmc.Cell(
    fill=flibe, region=+sphere_surface & -flibe_surface, name="Outside"
)
...
main_cell = openmc.Cell(
    fill=lattice, region=-flibe_surface & +bottom & -top, name="Main cell"
)
