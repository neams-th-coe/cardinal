...
vessel_inner_diameter = 3.4  # inner diameter of reactor vessel (m)
vessel_thickness = 0.05  # vessel thickness (m) - no value provided in [1], this is selected arbitrarily
top_reflector_thickness = 1.189  # top graphite reflector thickness (m)
...
fluid_density = 5.5508  # coolant density (kg/m3)
...
total_B10_wt_percent = (
    0.002  # total weight percent of B-10 in the poison material (B_nC)
)
...
num_layers_for_plots = 50  # number of averaging layers for making plots
