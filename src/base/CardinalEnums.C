...
getNekFieldEnum()
{
  return MooseEnum("velocity_x velocity_y velocity_z velocity velocity_component "
                   ...
                   "scalar01 scalar02 scalar03 unity usrwrk00 usrwrk01 usrwrk02 zero");
}
...
getTallyScoreEnum()
{
  return MultiMooseEnum(
      ...
      "flux H3_production total absorption scatter nu_scatter fission nu_fission prompt_nu_fission "
