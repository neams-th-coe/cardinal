    ...
    _symmetry(nullptr)
{
  ...
  switch (_tally_type)
  {
    case tally::cell:
    {
      ...
      readBlockParameters("tally_blocks", _tally_blocks, _tally_block_names);
